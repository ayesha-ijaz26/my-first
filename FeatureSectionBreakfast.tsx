...
const data = [
  { id: 0, img: "/product__3.webp", name: "Jewel Cranberries", price: "$500" },
  { id: 1, img: "/product__2.webp", name: "Crunchy Crisps", price: "$300" },
  { id: 2, img: "/product__4.webp", name: "Red Dates", price: "$200" },
  { id: 3, img: "/product__5.webp", name: "Fresh Tomatoes", price: "$100" },
];
      ...
      <div className="lg:flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Buy best quality breakfast online feom big-basket stop near you.
          </p>
        </div>
        <div className="space-x-4 mt-8 lg:mt-0 lg:text-right">
